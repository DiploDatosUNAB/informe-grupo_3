...
Según se observa en el gráfico histograma de frecuencias del trabajo pago según grupo etario, el periodo de mayor dedicación de tiempo se observa entre los 25 y 64 años de edad. Siendo el rango 14-24 y 65+ los de menor frecuencia.
Para el rango de 25-39 años no se observan diferencias significativas de didicación por sexo.
En cambio, para el rango de edad de 40-64 años se distingue una menor dedicación de tiempo de las mujeres al trabajo pago.
...
Respecto al trabajo domestico, en todos los rangos etarios se observa una menor dedicación horaria por parte de los varones en comparación a la dedicación de las mujeres, siendo más acentuada en el periodo de 25-39 años.
Por su parte, en el caso de las mujeres, la mayor dedicación al trabajo doméstico se acentúa más  a partir de los 50 años. 
